    ...
    <div class="navbar bg-primary text-primary-content shadow-lg px-4 md:px-8">
        ...
        <div class="flex-none">
            <ul class="menu menu-horizontal px-1 font-semibold items-center gap-2">
                ...
                <li><a href="{{ route('editoras.index') }}" class="active">Editores</a></li>
                ...
                <div class="overflow-x-auto">
                    <table class="table table-zebra w-full">
                        <thead class="bg-base-200">
                            <tr><th>Nome da Editora</th><th>Localização</th><th class="text-right">Ação</th></tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td class="font-bold">Publicações Europa-América</td>
                                <td>Portugal</td>
                                <td class="text-right"><button class="btn btn-ghost btn-xs">Contactar</button></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
